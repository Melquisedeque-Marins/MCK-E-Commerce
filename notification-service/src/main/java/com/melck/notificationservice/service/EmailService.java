...
//        String q = firstName[0];
        ...
        email.setEmailTo("melck_junior@hotmail.com");
        email.setOwnerRef("user");

        email.setSubject("Account registered successfully");
        email.setEmailFrom("mck.enterprises.clinic@gmail.com");
        email.setText("<h1>Olá, <style='text-transform:capitalize;'>" + "user" + "</h1>"
        ...
        try {
            ...
            helper.setTo("melck_junior@hotmail.com");
